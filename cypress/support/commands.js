...
Cypress.Commands.add('detalheFaturamento', (nome, sobrenome, empresa, pais, endereco, complemento, cidade, estado, cep, telefone, email, adicionais ) =>{
    ...
    cy.get('#order_comments').type(adicionais)
});
